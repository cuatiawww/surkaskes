  ...
  return (
    <div className="min-h-screen bg-[#fbffff] text-slate-800">
      ...
      <div className="px-4 sm:px-5 lg:px-6 py-4 border-b border-[#e8e8e8]">
        <div className="max-w-[1440px] mx-auto flex items-center gap-2 text-[14px] text-[#0f8f96]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-4 mb-2">
              <div className="bg-[#f5f5f5] p-5 rounded-lg border-l-4 border-[#0f8f96]">
                <p className="text-[15px] text-[#2f3a3a] leading-relaxed">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg border border-[#e0e0e0] p-4 sticky top-24">
                <p className="text-[13px] font-bold uppercase text-[#4a7a7a] mb-1">Contents</p>
                <nav className="space-y-0.5 mb-4">
                  {sidebarMenu.map((item, idx) => (
                    <button
                      key={item.id}
                      onClick={() => setActiveSection(item.id)}
                      className={`w-full flex items-start gap-2 px-2 py-2 text-[14px] rounded transition-all text-left ${
                ...
                <div className="border-t border-[#e0e0e0] pt-4">
                  <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-[14px] font-semibold text-white bg-[#0f8f96] rounded-lg hover:bg-[#0d7a81] transition-all shadow-[0_2px_8px_rgba(15,143,150,0.2)]">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              {activeSection === 'poin-utama' && (
                <div className="space-y-4">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Poin utama</h2>
                  <ul className="space-y-3 text-[15px] text-[#3f5a5a] leading-relaxed">
              ...
              {activeSection === 'ringkasan-kasus' && (
                <div className="space-y-6">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Laporan Pengawasan Kasus Influenza dan COVID-19</h2>
                  ...
                  <div className="flex gap-2 border-b border-[#e0e0e0] overflow-x-auto">
                    {[
                      ...
                      <button
                        ...
                        className={`px-4 py-3 text-[14px] font-semibold whitespace-nowrap transition-all border-b-2 ${
                        ...
                        <table className="w-full">
                          <thead>
                            <tr className="bg-[#e8faf8] border-b border-[#cfeeed]">
                              <th className="px-4 py-3 text-left text-[14px] font-bold text-[#0f8f96]">Indikator</th>
                              <th className="px-4 py-3 text-left text-[14px] font-bold text-[#0f8f96]">Tren</th>
                              <th className="px-4 py-3 text-left text-[14px] font-bold text-[#0f8f96]">Level</th>
                              <th className="px-4 py-3 text-left text-[14px] font-bold text-[#0f8f96]">Keterangan</th>
                            </tr>
                          </thead>
                          <tbody>
                            {[
                              ...
                              <tr key={idx} className="border-b border-[#e0e0e0] hover:bg-[#fbffff] transition-colors">
                                <td className="px-4 py-3 text-[14px] text-[#3f5a5a] font-semibold">{row.indikator}</td>
                                <td className="px-4 py-3 text-[14px]">
                                  <span className={`inline-block px-2 py-1 rounded text-[13px] font-semibold ${
                                    row.tren === 'Menurun' ? 'bg-[#d4f1ed] text-[#0f8f96]' :
                                    row.tren === 'Meningkat' ? 'bg-[#ffe8d6] text-[#d97706]' :
                                    'bg-[#f0f0f0] text-[#666]'
                                  }`}>{row.tren}</span>
                                </td>
                                <td className="px-4 py-3 text-[14px] text-[#4a7a7a]">{row.level}</td>
                                <td className="px-4 py-3 text-[14px] text-[#4a7a7a]">{row.keterangan}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            {[
                              ...
                              <tr key={idx} className="border-b border-[#e0e0e0] hover:bg-[#fbffff] transition-colors">
                                <td className="px-4 py-3 text-[14px] text-[#3f5a5a] font-semibold">{row.indikator}</td>
                                <td className="px-4 py-3 text-[14px]">
                                  <span className="inline-block px-2 py-1 rounded text-[13px] font-semibold bg-[#d4f1ed] text-[#0f8f96]">{row.tren}</span>
                                </td>
                                <td className="px-4 py-3 text-[14px] text-[#4a7a7a]">{row.level}</td>
                                <td className="px-4 py-3 text-[14px] text-[#4a7a7a]">{row.keterangan}</td>
                              </tr>
              ...
              {activeSection === 'lab-surveillance' && (
                <div className="space-y-8">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Surveilans Laboratorium</h2>

                  {/* Kasus COVID-19 */}
                  <div className="space-y-3">
                    <h3 className="text-xl font-bold text-[#1a3535]">Kasus COVID-19</h3>
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 1. Tren mingguan konfirmasi COVID-19</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik1.png" alt="Tren mingguan COVID-19" width={800} height={400} className="w-full h-auto" />
                    </div>
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 2. Tren mingguan Positivity rate COVID-19</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik2.png" alt="Positivity rate COVID-19" width={800} height={400} className="w-full h-auto" />
                    </div>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed mt-2">
                  ...
                  <div className="space-y-3 pt-4 border-t border-[#e0e0e0]">
                    <h3 className="text-xl font-bold text-[#1a3535]">Kasus Influenza</h3>
                    <p className="text-[15px] text-[#4a7a7a]">Data hingga 21-Desember-2025 menunjukkan bahwa proporsi influenza pada minggu ke-50 meningkat menjadi 17% dari 17% di minggu sebelumnya. Dari kasus influenza yang terdeteksi 43% terjadi pada kelompok usia &ge;60 tahun.</p>
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 4. Proporsi Kasus Influenza Mingguan dari Semua Spesimen diperiksa</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                        <Image src="/grafik4.png" alt="Proporsi influenza mingguan" width={600} height={400} className="w-full h-auto" />
                      </div>
                      <div>
                        <h4 className="text-[15px] font-bold text-[#3f5a5a] mb-2">Grafik 5. Tren Jumlah Kasus Influenza Mingguan Berdasarkan Kelompok Umur</h4>
                        <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                  ...
                  {/* Multipatogen */}
                  <div className="space-y-3 pt-4 border-t border-[#e0e0e0]">
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 6a. Proporsi Positif influenza, SARS-Cov-2, RSV dan Rhinovirus</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                        <Image src="/grafik6.png" alt="Proporsi multipatogen A" width={600} height={400} className="w-full h-auto" />
                      </div>
                      <div>
                        <h4 className="text-[15px] font-bold text-[#3f5a5a] mb-2">Grafik 6b. RSV dan Rhinovirus dan Parainfluenza Virus, dan Adenovirus</h4>
                        <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                  ...
                  {/* Subtipe & Varian */}
                  <div className="space-y-3 pt-4 border-t border-[#e0e0e0]">
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 7. Subtype Influenza Mingguan dari Semua Spesimen diperiksa</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                        <Image src="/grafik7.png" alt="Subtype influenza mingguan" width={600} height={400} className="w-full h-auto" />
                      </div>
                      <div>
                        <h4 className="text-[15px] font-bold text-[#3f5a5a] mb-2">Grafik 7. Proporsi Subtype Influenza</h4>
                        <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                    ...
                    <h3 className="text-lg font-bold text-[#1a3535] mt-4">Varian COVID-19</h3>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
              ...
              {activeSection === 'perawatan-primer' && (
                <div className="space-y-6">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Pengawasan Perawatan Primer</h2>

                  <div className="space-y-4">
                    <h3 className="text-lg font-bold text-[#1a3535]">Surveilans Puskesmas</h3>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
                    ...
                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-4">Grafik 19. Pandemic Influenza Severity Assessment (PISA) dari kasus yang berkunjung ke Puskesmas</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik22.png" alt="PISA assessment puskesmas" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <p className="text-[14px] text-[#4a7a7a] font-semibold mt-2">Note:</p>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
                    ...
                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-4">Grafik 20. Spesimen ILI Diperiksa</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik20.png" alt="Spesimen ILI diperiksa" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-4">Grafik 21. Proporsi Positif hasil pemeriksaan spesimen ILI</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik21.png" alt="Proporsi positif ILI" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-2">Grafik 22. proporsi positif pemeriksaan spesimen ILI tahun 2025 week 1-50 berdasarkan kelompok umur.</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik22b.png" alt="Proporsi positif ILI per usia" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-2">Grafik 22. proporsi positif influenza dan SARS-Cov-2 dari sentinel ILI</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
              ...
              {activeSection === 'perawatan-sekunder' && (
                <div className="space-y-8">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Pengawasan perawatan Sekunder</h2>

                  {/* COVID-19 RS */}
                  <div className="space-y-3">
                    <h3 className="text-xl font-bold text-[#1a3535]">Perawatan COVID-19 di Rumah Sakit</h3>
                    <p className="text-[15px] text-[#4a7a7a]">Data ini dikumpulkan dari 35 rumah sakit sentinel Surveilans SARI di Indonesia. Penting untuk diketahui bahwa data yang kami sajikan ini masih bersifat sementara dan bisa berubah di kemudian hari.</p>
                    <p className="text-[15px] text-[#4a7a7a]">Berdasarkan data dari 35 rumah sakit sentinel SARI, berikut adalah ringkasan mengenai jumlah kasus COVID-19 yang didapatkan dari rumah sakit sentinel pada minggu 50 tahun 2025:</p>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
                    ...
                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-3">Grafik 24. Proporsi Kasus COVID-19 Mingguan dari Kasus yang dirawat di RS</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik24.png" alt="Proporsi COVID-19 RS" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-3">Grafik 25. Tren Jumlah Kasus COVID-19 yang dirawat di RS Berdasarkan Kelompok Umur</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik25.png" alt="Tren COVID-19 RS per usia" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <h3 className="text-lg font-bold text-[#1a3535] mt-2">Perawatan ICU COVID-19 di Rumah Sakit</h3>
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 25. Tren Jumlah Kasus COVID-19 yang membutuhkan Perawatan ICU Berdasarkan Kelompok Umur</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                  ...
                  {/* Influenza RS */}
                  <div className="space-y-3 pt-4 border-t border-[#e0e0e0]">
                    <h3 className="text-xl font-bold text-[#1a3535]">Perawatan Influenza di Rumah Sakit</h3>
                    <p className="text-[15px] text-[#4a7a7a]">Berdasarkan data yang terkumpul dari 35 rumah sakit sentinel Surveilans SARI di Indonesia pada minggu 50 tahun 2025, berikut adalah ringkasan mengenai kasus influenza yang dirawat:</p>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
                    ...
                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-3">Grafik 28. Pandemic Influenza Severity Assessment (PISA) dari Kasus Influenza yang dirawat di RS</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                        <Image src="/grafik28.png" alt="PISA influenza RS" width={600} height={400} className="w-full h-auto" />
                      </div>
                      <div>
                        <h4 className="text-[15px] font-bold text-[#3f5a5a] mb-2">Grafik 29. Jumlah Kasus Influenza yang dirawat di RS berdasarkan Sub tipe Influenza</h4>
                        <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                    ...
                    <h4 className="text-[15px] font-bold text-[#3f5a5a] mt-3">Grafik 30. Tren Jumlah Kasus Influenza yang dirawat di RS Berdasarkan Kelompok Umur</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
                      <Image src="/grafik30.png" alt="Tren influenza RS per usia" width={800} height={400} className="w-full h-auto" />
                    </div>

                    <h3 className="text-xl font-bold text-[#1a3535] mt-4">Perawatan Influenza ICU</h3>
                    <h4 className="text-[15px] font-bold text-[#3f5a5a]">Grafik 32. Jumlah Kasus Influenza yang membutuhkan perawatan ICU berdasarkan Sub tipe Influenza</h4>
                    <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-hidden">
              ...
              {activeSection === 'vaksin' && (
                <div className="space-y-6">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Cakupan Vaksin</h2>

                  <div className="space-y-3">
                    <h3 className="text-lg font-bold text-[#1a3535]">Cakupan Vaksinasi COVID-19</h3>
                    ...
                    <a
                      ...
                      className="inline-block text-[14px] font-semibold text-[#0f8f96] underline hover:text-[#0c7a80]"
                    >
                  ...
                  <div className="space-y-4 pt-4 border-t border-[#e0e0e0]">
                    <h3 className="text-lg font-bold text-[#1a3535]">Penyakit infeksi emerging pernafasan akut berat</h3>

                    <h4 className="text-[15px] font-bold text-[#1a3535]">SITUASI SUSPEK MERS INDONESIA</h4>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
                    ...
                    <h4 className="text-[15px] font-bold text-[#1a3535] mt-4">SITUASI LEGIONELLOSIS INDONESIA</h4>
                    <ul className="space-y-2 text-[15px] text-[#3f5a5a] leading-relaxed">
              ...
              {activeSection === 'metodologi' && (
                <div className="space-y-4">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Metodologi dan Sumber Data</h2>
                  <p className="text-[15px] text-[#3f5a5a] leading-relaxed">
              ...
              {activeSection === 'latar-belakang' && (
                <div className="space-y-6">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Informasi dan Latar Belakang</h2>
                  <div className="space-y-3">
                    <p className="text-[15px] text-[#3f5a5a] leading-relaxed">
                  ...
                  <div className="space-y-3 pt-4 border-t border-[#e0e0e0]">
                    <h3 className="text-lg font-bold text-[#1a3535]">Himbauan Bagi Masyarakat Indonesia</h3>
              ...
              {activeSection === 'kontak' && (
                <div className="space-y-4">
                  <h2 className="text-[26px] font-bold text-[#1a3535] border-b border-[#e0e0e0] pb-2">Kontak & Informasi Lebih Lanjut</h2>
                  <p className="text-[15px] text-[#3f5a5a] leading-relaxed">
